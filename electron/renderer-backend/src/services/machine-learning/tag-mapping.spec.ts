import { calculateTags } from "./tag-mapping";

jest.mock("./methods/classification");
jest.mock("./methods/objectRecognition");

describe("calculateTags()", () => {
	it("with imageNetClassIds", async () => {
...
describe("custom tag: people", () => {
	...
	const validImageNetClassIds: number[] = [];
